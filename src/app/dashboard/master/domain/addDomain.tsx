...
import { createDomain } from "src/redux/slices/masterSlice";
...
const AddDomain = ({ open, setOpen }: DomainModalProps) => {
  ...
  return (
    <RightModal open={open} toggleOpen={handleClose} heading='Add Domain' showIcon={false} icon='uploadDarkIcon'>
      {isManualSave ? (
        <>
          <ModalContainer>
            <form>
